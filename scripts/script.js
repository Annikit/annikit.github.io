function openPopup(project) {
    ...
    if (project === 'videohosting') {
        ...
        `;
    } else if (project === 'mail-service') {
        popupText.innerHTML = `
            <h3>Почта Анникит</h3>
            <p>Проект, созданный ради интереса и для проверки своих навыков. Это упрощённый аналог Gmail с базовым функционалом: отправка, приём писем и простая сортировка. Отличная практика и способ применить полученные знания на деле.</p>
        `;
