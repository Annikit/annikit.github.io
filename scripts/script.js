function openPopup(project) {
    ...
    if (project === 'videohosting') {
        ...
        popupText.innerHTML = `
            ...
            <p>Телеканал Анникит — сложный и трудоёмкий проект, остающийся одним из самых грандиозных в нашей истории. Мы построили полноценную систему вещания: с прямыми эфирами, авторскими программами и независимыми новостями. Этот проект объединил специалистов из разных сфер — журналистов, техников, дизайнеров и маркетологов. Работа продолжается круглосуточно, и наша команда постоянно развивает формат вещания.</p>
        `;
